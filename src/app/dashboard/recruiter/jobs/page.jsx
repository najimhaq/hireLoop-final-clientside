...
const RecruiterJobs = async () => {
  ...
  console.log('Recruiter page', company);
                    ...
                    <td colSpan={6} className='px-6 py-20 text-center'>
                      <div className='mx-auto max-w-sm'>
                        ...
                        <Link
                          ...
                          className='mt-6 inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-purple-600 to-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-purple-200 transition-all hover:shadow-xl'
                        >
                          Create Job Posting
